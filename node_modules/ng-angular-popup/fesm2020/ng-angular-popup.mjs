...
class NgToastService {
    ...
    success(message) {
        this.toastDetails$.next({ type: 'success', title: message.title, position: message.position, message: message.message, duration: message.duration, sticky: message.sticky });
    }
    error(message) {
        this.toastDetails$.next({ type: 'error', title: message.title, position: message.position, summary: message.message, duration: message.duration, sticky: message.sticky });
    }
    info(message) {
        this.toastDetails$.next({ type: 'info', title: message.title, position: message.position, message: message.message, duration: message.duration, sticky: message.sticky });
    }
    warning(message) {
        this.toastDetails$.next({ type: 'warning', title: message.title, message: message.message, position: message.position, duration: message.duration, sticky: message.sticky });
    }
}
